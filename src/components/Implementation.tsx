  ...
  const timeline = [
    {
      ...
      description: "System design, component selection, safety certifications",
    },
    {
      year: "2026 Q1-Q2",
      phase: "Pilot Installation",
      description: "Install on first barge, integration testing",
    },
    {
      year: "2026 Q3-Q4",
      phase: "Testing & Validation",
      description: "Power testing, consumption monitoring, H₂ output analysis",
    },
    {
      year: "2027+",
      phase: "Fleet Scaling",
      description: "Roll out to 10+ barges",
    },
  ];
              ...
              <Card key={index} className="p-6">
                <div className="flex items-start space-x-4">
                  <div className="w-12 text-center flex-shrink-0">
                    <div className="h-12 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Dynamometer analysis of power output improvements
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-sm text-muted-foreground">
                  GPS tracking and fuel consumption monitoring
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
