        ...
        <Card className="p-8 max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center py-3 border-b border-border">
              ...
              <span className="text-lg font-semibold">$60-80k</span>
            </div>
            <div className="flex justify-between items-center py-3 border-b border-border">
              <span className="text-lg">H₂ Electrolysis System</span>
              <span className="text-lg font-semibold">$40-60k</span>
            </div>
            <div className="flex justify-between items-center py-3 border-b border-border">
              <span className="text-lg">LiFePO4 Battery (300 kWh)</span>
              <span className="text-lg font-semibold">$30-40k</span>
            </div>
            <div className="flex justify-between items-center py-3 border-b border-border">
              <span className="text-lg">Ultrasonic Cooling System</span>
              <span className="text-lg font-semibold">$10-15k</span>
            </div>
            <div className="flex justify-between items-center py-3 border-b border-border">
            ...
            <div className="flex justify-between items-center pt-4">
              ...
              <span className="text-2xl font-bold text-primary">$150-200k</span>
            </div>
          </div>
        </Card>
      </div>
